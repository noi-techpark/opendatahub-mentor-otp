...
module.exports = {
  ...
  // Babel configuration needs to be provided here and not through .babelrc
  // to also properly apply to the files from the upstream repository
  babel: {
    "plugins": [
  ...
  webpack: {
    ...
    alias: {
        '@otp-react-redux': path.resolve(__dirname, 'lib/vendor/otp-react-redux')
    },
    ...
    configure: function (webpackConfig, { env, paths }) {
      ...
      paths.appSrc = [path.resolve(__dirname, './lib/app'), path.resolve(__dirname, './lib/vendor/otp-react-redux/lib')]
      paths.appIndexJs = path.resolve(__dirname, './lib/app/main.js')
      ...
      webpackConfig.plugins = [
        ...
        new CircularDependencyPlugin({
          ...
          failOnError: true,
          include: /lib\/app|otp-react-redux\/lib/,
          onDetected({ paths }) {
